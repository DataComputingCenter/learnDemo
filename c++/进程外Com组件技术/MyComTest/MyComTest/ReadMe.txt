========================================================================
    ACTIVE TEMPLATE LIBRARY : MyComTest Project Overview
========================================================================

AppWizard has created this MyComTest project for you to use as the starting point for
...
MyComTest.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (MyComTest.h)
        GUID definitions                                (MyComTest_i.c)
        A type library                                  (MyComTest.tlb)
        Marshaling code                                 (MyComTest_p.c and dlldata.c)

MyComTest.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in MyComTest.idl. It will be regenerated by MIDL during compilation.
...
MyComTestps.vcxproj
	...
	dlldata.c, MyComTest_i.c and MyComTest_p.c which are required
	to build the proxy/stub DLL.

MyComTestps.vcxproj.filters
